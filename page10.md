...
<div id="admin-section" style="display:none; margin-top: 40px; padding: 20px; background: rgba(0, 0, 0, 0.5); border: 2px solid #ffd700; border-radius: 12px; box-shadow: 0 0 10px rgba(255, 215, 0, 0.2);">
  ...
  <button onclick="sendNewsletter()" class="admin-btn">Send Weekly Newsletter</button>
</div>
